...
def transform(
    ...
    logging.info(
        f'Transformacao silver: {cred_origem["host"]}:{cred_origem["port"]} '
    ...
    for _, row in df_steps.iterrows():
        ...
        connection_origem = connection_origem_id
        if database_source:
            if 'prata' in database_source or 'silver' in database_source:
                connection_origem = connection_destino_id
